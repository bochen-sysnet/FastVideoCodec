...
def LoadModel(CODEC_NAME,compression_level = 2,use_split=False):
    ...
    ####### Codec model 
    model = get_codec_model(CODEC_NAME,loss_type=loss_type,compression_level=compression_level,use_split=use_split,noMeasure=False)
        ...
        for data_idx,_ in enumerate(test_iter):
            ...
            with torch.no_grad():
                ...
                if l>args.fP+1:
                    ...
                    psnr_module.update(psnr,l-args.fP-1)
                else:
