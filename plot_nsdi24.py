...
Sbpps = [
[0.0594,0.0932,0.1397,0.2075,0.3033,0.4398,0.6336,0.8942],
[0.0266,0.0431,0.0734,0.1421,0.3048,0.6370,1.1764,1.9298],
]
SPSNRs = [
[32.40,33.77,35.22,36.51,37.69,38.96,40.17,41.29],
[31.12,32.75,34.18,35.41,36.48,37.41,38.20,38.82],
]
sc_labels = ['SSF','x264-veryfast']

colors_tmp = ['#e3342f','#f6993f','#ffed4a','#38c172','#4dc0b5','#3490dc','#6574cd','#9561e2','#f66d9b']
line_plot(Sbpps,SPSNRs,sc_labels,colors_tmp,
		'/home/bo/Dropbox/Research/NSDI24/images/rdtradeoff_mcl.eps',
		'Bit Per Pixel','PSNR (dB)',lbsize=24,lfsize=18,linewidth=1,markersize=4)

Sbpps = [
[0.0449,0.0699,0.1029,0.1545,0.2138,0.2907,0.4032,0.5672],
...
SPSNRs = [
[33.96,35.43,37.13,38.63,39.96,41.50,42.93,44.29],
...
colors_tmp = ['#e3342f','#f6993f','#ffed4a','#38c172','#4dc0b5','#3490dc','#6574cd','#9561e2','#f66d9b']
line_plot(Sbpps,SPSNRs,sc_labels,colors_tmp,
		'/home/bo/Dropbox/Research/NSDI24/images/rdtradeoff_uvg.eps',
		'Bit Per Pixel','PSNR (dB)',lbsize=24,lfsize=18,linewidth=1,markersize=4)
