...
labels_tmp = ['SSF','x264f','x264m','x264s','x265f','x265m','x265s']
...
for k,metric in enumerate(['QoE','quality','rebuffer','bw']):
	...
	groupedbar(meanQoE_all,stdQoE_all,f'Normalized {names[k]}', 
		f'/home/bo/Dropbox/Research/NSDI24/data/{metric}mean_{trace}.eps',methods=labels_tmp,colors=colors_tmp,
		envs=['Limited BW','Adequate BW'],ncol=ncol,sep=1,width=0.1,labelsize=labelsize,lfsize=16,bbox_to_anchor=(1.22,1.05),xlabel='Hardware',ratio=.7)
# 	if metric == 'QoE':
