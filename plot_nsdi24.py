...
def plot_RD_tradeoff(methods = ['Vesper','ELFVC','SSF','x264f','x264m','x264s','x265f','x265m','x265s']):
	...
	SPSNRs = np.array(SPSNRs)[selected_rows]
	Sbpps = np.array(Sbpps)[selected_rows]
...
def plot_encoding_speed():
	...
	y = [0.022, 0.0102, 0.0058,0.004889435564435564, 0.005005499857285572, 0.005083814399885828, 0.0074054160125588695, 0.0058336038961038965, 0.006322325888397318] 
