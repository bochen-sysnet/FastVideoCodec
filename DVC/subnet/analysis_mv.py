...
class Analysis_mv_net(nn.Module):
    ...
    Compress motion
    '''
    def __init__(self, useAttn=False, out_channels = out_channel_mv, conv_channels=out_channel_mv):
        ...
        self.conv2 = nn.Conv2d(conv_channels, conv_channels, 3, stride=1, padding=1)
        ...
        self.conv4 = nn.Conv2d(conv_channels, conv_channels, 3, stride=1, padding=1)
        torch.nn.init.xavier_normal_(self.conv4.weight.data, math.sqrt(2))
        torch.nn.init.constant_(self.conv4.bias.data, 0.01)
        self.relu4 = nn.LeakyReLU(negative_slope=0.1)
        self.conv5 = nn.Conv2d(conv_channels, conv_channels, 3, stride=2, padding=1)
        ...
        self.conv6 = nn.Conv2d(conv_channels, conv_channels, 3, stride=1, padding=1)
        ...
        self.conv7 = nn.Conv2d(conv_channels, conv_channels, 3, stride=2, padding=1)
