...
class Base(nn.Module):
    def __init__(self,name,loss_type='P',compression_level=0):
        ...
        if self.useER: 
            ...
            act_func = 4
            self.mvGenNet = nn.ModuleList([CodecNet(        [(0,kernel_size,1,128,ch1),act_func,(0,kernel_size,1,ch1,ch1),act_func,(11,kernel_size,1,ch1,ch1),(0,kernel_size,1,ch1,128),act_func,(0,kernel_size,1,ch1,128),]) for _ in range(num_blocks)]) 
