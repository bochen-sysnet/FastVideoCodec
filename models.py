...
class Base(nn.Module):
    def __init__(self,name,loss_type='P',compression_level=0):
        ...
        if self.useER: 
            ...
            self.respriorGenNet = nn.ModuleList([CodecNet([(0,kernel_size,1,64,ch3),(11,kernel_size,1,ch3,ch3),(0,kernel_size,1,ch3,ch3),3,(11,kernel_size,1,ch3,ch3),(0,kernel_size,1,ch3,ch3),3,(11,kernel_size,1,ch3,ch3),(0,kernel_size,1,ch3,ch3),3,(11,kernel_size,1,ch3,ch3)]) for _ in range(num_blocks)])
